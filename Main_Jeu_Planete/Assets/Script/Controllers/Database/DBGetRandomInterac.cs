...
public class DBGetRandomInterac : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        StartCoroutine(GetRandomInterac());
    }
    
    public IEnumerator GetRandomInterac()
    {
        string strVarURLGet = "";
        strVarURLGet = "&interaction=" + nbInterac;
